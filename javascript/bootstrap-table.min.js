...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function() {
        ...
        if(this.options.paginationShowPageGo){
            ...
            html.push(
                ...
                '<li class=""><input id="jump-go-num" type="number" class="page-input" value="' + this.options                                  .pageNumber + '" min="1" /></li>',
    ...
    BootstrapTable.prototype.onPageGo = function (event) {
        ...
        var toPageVlue = +$toPage.val();
        if(toPageVlue > this.totalPages){
            this.$pagination.find('.page-input').val(this.totalPages);
            toPageVlue = this.totalPages;
        }
        if (this.options.pageNumber === toPageVlue) {
            return false;
        }
        this.selectPage(toPageVlue);
 ...
 * 跳页回车事件
 */
$(document).on('keypress','.page-input',function(event){
    if (event.keyCode == "13" && document.activeElement.id == "jump-go-num") {
        $(".jump-go").click();
        return false;
    }
})
